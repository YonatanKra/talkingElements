const ResponsiveVoice = function () {
  ...
  a.responsivevoices = [{
  ...
  }, {name: "UK English Male", flag: "gb", gender: "m", voiceIDs: [0, 277, 202, 75, 4, 2, 256, 285, 341, 159, 6, 7]}, {
    name: "US English Female", flag: "us", gender: "f", voiceIDs: [39,
      40, 41, 42, 383, 205, 204, 43, 173, 235, 283, 339, 44]
  }, {
    name: "US English Male",
    flag: "us",
    gender: "m",
    voiceIDs: [234, 282, 338, 236, 284, 340, 237, 382, 2, 4, 0, 6, 7, 75, 159]
  }, {name: "Arabic Male", flag: "ar", gender: "m", voiceIDs: [96, 95, 97, 196, 388]}, {
    name: "Arabic Female",
    flag: "ar",
    gender: "f",
    voiceIDs: [98]
  ...
  }, {name: "Australian Male", flag: "au", gender: "m", voiceIDs: [86, 381, 386]}, {
    name: "Brazilian Portuguese Female",
    flag: "br", gender: "f", voiceIDs: [245, 124, 123, 125, 186, 223, 126]
  }, {
    ...
    flag: "cn",
    gender: "f",
    voiceIDs: [249, 58, 59, 380, 281, 231, 155, 60, 191, 268, 297, 353, 269, 298, 354, 61]
  }, {
    name: "Chinese Male",
    flag: "cn",
    gender: "m",
    ...
    name: "Chinese (Hong Kong) Male", flag: "hk", gender: "m", voiceIDs: [318,
      335, 374, 390]
  }, {
    name: "Chinese Taiwan Female",
    flag: "tw",
    gender: "f",
    voiceIDs: [194, 233, 253, 254, 305, 322, 361, 384, 319, 336, 375, 255]
  }, {name: "Chinese Taiwan Male", flag: "tw", gender: "m", voiceIDs: [320, 337, 376, 391]}, {
    name: "Czech Female",
    flag: "cz",
    gender: "f",
    ...
    name: "Deutsch Female", flag: "de", gender: "f",
    voiceIDs: [27, 28, 29, 30, 78, 170, 275, 199, 31, 261, 290, 346, 262, 291, 347, 32]
  }, {name: "Deutsch Male", flag: "de", gender: "m", voiceIDs: [307, 324, 363, 377, 393]}, {
    name: "Dutch Female",
    flag: "nl",
    gender: "f",
    voiceIDs: [243, 219, 84, 157, 158, 184, 45]
  }, {name: "Dutch Male", flag: "nl", gender: "m", voiceIDs: [157, 220, 407]}, {
    name: "Finnish Female",
    flag: "fi",
    gender: "f",
    voiceIDs: [90, 89, 91, 209, 92]
  }, {name: "Finnish Male", flag: "fi", gender: "m", voiceIDs: [160]}, {
    name: "French Female", flag: "fr", gender: "f", voiceIDs: [240, 21, 22, 23, 77, 178, 279, 210, 266,
      295, 351, 304, 321, 360, 26]
  }, {name: "French Male", flag: "fr", gender: "m", voiceIDs: [311, 328, 367, 378, 392]}, {
    name: "Greek Female",
    flag: "gr",
    gender: "f",
  ...
  }, {name: "Hindi Male", flag: "hi", gender: "m", voiceIDs: [394]}, {
    ...
    }, {name: "Indonesian Male", flag: "id", gender: "m", voiceIDs: [395]}, {
      name: "Italian Female",
      flag: "it",
      gender: "f",
      voiceIDs: [242, 33, 34, 35, 36, 37, 79, 181, 216, 271, 300, 356, 38]
    }, {name: "Italian Male", flag: "it", gender: "m", voiceIDs: [312, 329, 368, 406]}, {
      name: "Japanese Female",
      flag: "jp",
      gender: "f",
      voiceIDs: [248, 50, 51, 280, 217, 52, 153, 182, 273, 302, 358, 274, 303, 359, 53]
    }, {name: "Japanese Male", flag: "jp", gender: "m", voiceIDs: [313, 330, 369, 379, 396]},
    {
      name: "Korean Female",
      flag: "kr",
      gender: "f",
      voiceIDs: [54, 55, 56, 156, 183, 218, 306, 323, 362, 384, 57]
    }, {name: "Korean Male", flag: "kr", gender: "m", voiceIDs: [397]}, {
      name: "Latin Female",
      flag: "va",
      gender: "f",
      voiceIDs: [114],
    ...
    {name: "Polish Male", flag: "pl", gender: "m", voiceIDs: [314, 331, 370, 398]}, {
      name: "Portuguese Female",
      flag: "br",
      gender: "f",
      voiceIDs: [128, 127, 129, 187, 224, 272, 301, 357, 130]
    }, {name: "Portuguese Male", flag: "br", gender: "m", voiceIDs: [400]}, {
    ...
    }, {name: "Russian Male", flag: "ru", gender: "m", voiceIDs: [316, 333, 372, 387]}, {
      name: "Slovak Female", flag: "sk", gender: "f",
    ...
    }, {name: "Spanish Latin American Male", flag: "es", gender: "m", voiceIDs: [136, 310, 327, 366, 402]}, {
      name: "Swedish Female",
      flag: "sv", gender: "f", voiceIDs: [85, 149, 228, 65]
    }, {name: "Swedish Male", flag: "sv", gender: "m", voiceIDs: [148, 168]}, {
      name: "Tamil Male",
      flag: "hi",
      gender: "m",
      voiceIDs: [141]
      ...
      gender: "m",
      voiceIDs: [404]
    }, {name: "Vietnamese Female", flag: "vi", gender: "f", voiceIDs: [405]}, {
      name: "Vietnamese Male",
      flag: "vi", gender: "m", voiceIDs: [146]
    ...
    {name: "Macedonian Male", flag: "mk", gender: "m", voiceIDs: [116]}, {
      ...
      gender: "f",
      voiceIDs: [117]
    }, {name: "Moldavian Male", flag: "md", gender: "m", voiceIDs: [117], deprecated: !0}, {
  ...
  a.voicecollection = [{name: "Google UK English Male"}, {name: "Agnes"}, {name: "Daniel Compact"}, {name: "Google UK English Female"}, {
    ...
    {name: "French France"}, {name: "franc\u00e9s Francia"}, {name: "Virginie Compact", rate: .5}, {
      name: "fr-FR",
      rate: .25
    }, {
    ...
    {name: "Tarik"}, {name: "ar-SA", rate: .25}, {
      ...
      lang: "eo", fallbackvoice: !0, service: "g1", gender: "male"
    ...
    }, {name: "Fallback Vietnamese Male", lang: "vi", fallbackvoice: !0, service: "g1", gender: "male"},
    {
      ...
      name: "Czech Male",
      lang: "cs", fallbackvoice: !0, service: "g1", voicename: "", gender: "male"
    }, {
      name: "Danish Male",
      lang: "da",
      fallbackvoice: !0,
    ...
    }, {name: "Norwegian Male", lang: "no", fallbackvoice: !0, service: "g1", voicename: "", gender: "male"},
    {
      ...
      lang: "zh_HK_#Hant"
    }, {name: "Chinese Taiwan", lang: "zh_TW_#Hant"}, {name: "Alex"}, {name: "Maged", lang: "ar-SA"}, {
      name: "Zuzana",
      lang: "cs-CZ"
    }, {name: "Sara", lang: "da-DK"}, {name: "Anna", lang: "de-DE"}, {name: "Melina", lang: "el-GR"}, {
      name: "Karen",
      lang: "en-AU"
    ...
    {name: "Microsoft Mark Mobile - English (United States)", lang: "en-US"}, {
      name: "native",
      lang: ""
    }, {name: "Google espa\u00f1ol"}, {name: "Google espa\u00f1ol de Estados Unidos"}, {name: "Google fran\u00e7ais"}, {name: "Google Bahasa Indonesia"}, {name: "Google italiano"}, {name: "Google Nederlands"}, {name: "Google polski"}, {name: "Google portugu\u00eas do Brasil"}, {name: "Google \u0440\u0443\u0441\u0441\u043a\u0438\u0439"}, {name: "Google \u0939\u093f\u0928\u094d\u0926\u0940"}, {name: "Google \u65e5\u672c\u8a9e"}, {name: "Google \u666e\u901a\u8bdd\uff08\u4e2d\u56fd\u5927\u9646\uff09"},
    {name: "Google \u7ca4\u8a9e\uff08\u9999\u6e2f\uff09"}, {
      name: "zh-HK",
      rate: .25
    }, {
  ...
  a.cache_ios_voices = [{name: "he-IL", voiceURI: "he-IL", lang: "he-IL"}, {
    ...
    {name: "ro-RO", voiceURI: "ro-RO", lang: "ro-RO"}, {
      ...
      voiceURI: "nl-BE",
      lang: "nl-BE"
    }, {name: "en-GB", voiceURI: "en-GB", lang: "en-GB"}, {name: "ar-SA", voiceURI: "ar-SA", lang: "ar-SA"}, {
      name: "ko-KR", voiceURI: "ko-KR",
      lang: "ko-KR"
  ...
  a.cache_ios9_voices = [{
    ...
    name: "Tessa", voiceURI: "com.apple.ttsbundle.Tessa-compact",
    lang: "en-ZA", localService: !0, "default": !0
  }, {
    name: "Monica",
    ...
    name: "Thomas", voiceURI: "com.apple.ttsbundle.Thomas-compact",
    lang: "fr-FR", localService: !0, "default": !0
  }, {
    name: "Carmit",
    ...
    name: "Alice", voiceURI: "com.apple.ttsbundle.Alice-compact",
    lang: "it-IT", localService: !0, "default": !0
  }, {
    name: "Kyoko",
    ...
    lang: "ru-RU", localService: !0, "default": !0
  }, {
    name: "Laura",
    ...
    name: "Ting-Ting", voiceURI: "com.apple.ttsbundle.Ting-Ting-compact",
    lang: "zh-CN", localService: !0, "default": !0
  }, {
    name: "Sin-Ji",
  ...
  a.cache_ios10_voices = [{
    ...
    name: "Anna",
    voiceURI: "com.apple.ttsbundle.Anna-compact", lang: "de-DE"
    ...
    name: "Catherine", voiceURI: "com.apple.ttsbundle.siri_female_en-AU_compact",
    lang: "en-AU"
    ...
    {name: "Samantha", voiceURI: "com.apple.ttsbundle.Samantha-compact", lang: "en-US"}, {
      ...
      name: "Daniel", voiceURI: "com.apple.ttsbundle.siri_male_fr-FR_compact",
      lang: "fr-FR"
      ...
      name: "Mei-Jia",
      voiceURI: "com.apple.ttsbundle.Mei-Jia-compact", lang: "zh-TW"
    }];
  a.cache_ios11_voices = [{
    ...
    name: "Martha",
    voiceURI: "com.apple.ttsbundle.siri_female_en-GB_compact", lang: "en-GB"
  }, {name: "Moira", voiceURI: "com.apple.ttsbundle.Moira-compact", lang: "en-IE"}, {
    name: "Aaron",
    voiceURI: "com.apple.ttsbundle.siri_male_en-US_compact",
    lang: "en-US"
  ...
  a.fallbackServicePath = "https://code.responsivevoice.org/" + (a.tstCompiled() ? "" : "develop/") +
    "getvoice.php";
      ...
      if (a.isPlaying()) a.log("Cancelling previous speech"), a.cancel(), setTimeout(function () {
        ...
        if (a.checkSpeechAllowed()) {
          ...
          e.addEventListener("end", a.speech_onend)), e.onerror = d.onerror || function (b) {
            ...
            var m =
              a.selectBest([f.collectionvoice.volume, f.systemvoice.volume, 1]);
            if (null != d) {
  ...
  a.fallback_startPart = function () {
    ...
    (a.log("RV: Speech cancelled due to errors"), a.speech_onend()), a.fallback_audio.addEventListener("ended", a.fallback_finishPart), a.useTimer && a.startTimeout(a.multipartText[a.fallbackChunkIndex], a.fallback_finishPart))
  };
  ...
  a.fallback_finishPart = function (b) {
    a.isFallbackAudioPlaying() ? (a.checkAndCancelTimeout(), a.timeoutId =
      setTimeout(a.fallback_finishPart, 1E3 * (a.fallback_audio.duration - a.fallback_audio.currentTime))) : (a.checkAndCancelTimeout(), a.fallbackChunkIndex < a.fallbackChunks.length - 1 ? (a.fallbackChunkIndex++, a.fallback_startPart()) : a.speech_onend())
  };
  a.cancel = function () {
    a.checkAndCancelTimeout();
  ...
  a.OnFinishedPlaying = function (b) {
    if (null !=
      a.msgparameters && null != a.msgparameters.onend) a.msgparameters.onend()
  };
  ...
  a.mapRVs = function () {
    for (var b = 0; b < a.responsivevoices.length; b++) for (var c = a.responsivevoices[b], d = 0; d < c.voiceIDs.length; d++) {
      ...
      if (1 != h.fallbackvoice) {
        ...
        if (null != k) {
          c.mappedProfile =
            {systemvoice: k, collectionvoice: h};
          break
        }
      } else {
  ...
  a.getSystemVoice = function (b) {
    ...
    for (var h = 0; h < a.systemvoices.length; h++) if (0 ===
      a.systemvoices[h].name.localeCompare(b) || 0 === a.systemvoices[h].name.replace(new RegExp("\\s+|" + c, "g"), "").replace(/ *\([^)]*\) */g, "").localeCompare(d)) return a.systemvoices[h];
    return null
  };
  a.getResponsiveVoice = function (b) {
    for (var c = 0; c < a.responsivevoices.length; c++) if (a.responsivevoices[c].name == b) return b = a.fallbackMode, a.fallbackMode = !0 === a.responsivevoices[c].mappedProfile.collectionvoice.fallbackvoice || !0 === a.forcedFallbackMode ? !0 : !1, b != a.fallbackMode && (a.mapRVs(), a.Dispatch("OnServiceSwitched")),
  ...
  a.clearFallbackPool = function () {
    for (var b = 0; b < a.fallback_audiopool.length; b++) null != a.fallback_audiopool[b] &&
